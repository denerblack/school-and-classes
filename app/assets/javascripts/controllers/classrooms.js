console.log("Teste");
var classroomCenter = angular.module('ClassroomCenter', ['ngResource', 'sessionService']);
...
classroomCenter.controller("classroomsController", ["$scope", "Classroom", "Session",  function($scope, Classroom, Session) {
    "use strict";
